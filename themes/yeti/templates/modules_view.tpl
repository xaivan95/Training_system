<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand visible-sm visible-xs visible-lg" href="index.php">
                <img src="{$smarty.const.CFG_IMG_DIR}logo.png" title="КАОС 54 кафедра" alt="Logo" width="32"
                     height="32" style="margin-top: -4px;">
            </a>
            <a class="navbar-brand visible-sm visible-xs visible-lg" href="index.php">КАОС 54 кафедра</a>
        </div>
    ...
    {if $WEB_APP.user_info_title!==''}
        <div class="row navbar-right navbar-text">
            <div class="col-xs-12">
                ...
                {if $WEB_APP.user_info_login eq 'anonymous'}<a href="?module=login"
                                                               class="navbar-link">{$text.txt_to_login}</a>
