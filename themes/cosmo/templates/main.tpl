...
<head>
 ...
 <script src="{$WEB_APP.cfg_url}system/AOS/1/TemplateData/UnityProgress.js"></script>
    ...
    <link rel="stylesheet" href="{$WEB_APP.cfg_url}system/AOS/1/TemplateData/style.css">
