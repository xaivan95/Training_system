...
*/
	...
	*/
	 ...
	 * Execute SQL
	 *
	 * @param string SQL statement to execute, or possibly an array holding prepared statement ($sql[0] will hold sql text)
	 ...
	 * @return integer|false the last inserted ID. Not all databases support this.
	 */
